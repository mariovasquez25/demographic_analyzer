...
def calculate_demographic_data(print_data=True):
    ...
    percentage_bachelors = df.loc[df['education'] ==
                                  'Bachelors', 'education'].count() / len(df) * 100
    ...
    higher_education_rich = higher_education.loc[df['salary'] == '>50K', 'salary'].count(
    ) / len(higher_education) * 100
    higher_education_rich = round(higher_education_rich, 1)

    lower_education_rich = lower_education.loc[df['salary'] == '>50K', 'salary'].count(
    ...
    rich_percentage = num_min_workers.loc[df['salary'] == '>50K', 'salary'].count(
    ) / len(num_min_workers) * 100
    ...
    top_IN_occupation = df.loc[df['native-country'] ==
